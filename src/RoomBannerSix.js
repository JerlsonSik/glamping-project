...
const RoomBannerSix = () => {
    return ( 
        <div className="container col-lg-8 my-4 RoomBannerFour">
            <div className="shadow my-2">
                <div className="row">
                    <div className="col-lg-5">
                        <div id="carouselExampleControlssix" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleControlssix" data-bs-slide="next">
                    ...
                    <div className="col-lg-7 align-self-center">
                        ...
                        <div className="p-3">
                            ...
                            <div className="my-3">
                                <p className="fs-2 fw-bold">The Leo Tent</p>
                            </div>                            
                            <table>
                            <tr>
                                <div className="">
                            ...
                            <tr>
                                <div>
                                    ...
                                    <td className="pe-2">
                                        <p className="fw-bold">Fireplace:</p>
                                    </td>
                                    <td>
                                        <p>Available</p>
                                    </td>
                            ...
                            <div className='mt-3 d-flex justify-content-between'>
                                <div className='d-flex align-items-center'>
                                    <a class="moredetails" data-bs-toggle="modal" data-bs-target="#exampleModalCenterSix">More Details</a>
                                </div>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLongTitle6">The Leo Tent</h5>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div id="carouselExampleControlsinner6" class="carousel slide" data-bs-ride="carousel">
                                                    ...
                                                    <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleControlsinner6" data-bs-slide="next">
                                                        <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                                        <span class="visually-hidden">Next</span>
                                                    </button>
                                                </div>
                                ...
                                <div className='justify-content-end'>
                                    <a href="https://booking.smoobu.com/9A749585" class="btn btn-primary">Book Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
