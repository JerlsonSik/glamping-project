    ...
    return ( 
        <div className="bg-light">
            <div className="container col-lg-10">
                <div class="card flex-lg-row align-items-center mb-4">
                    <img src="./sample-image.jpg" class="card-body col-lg-3 img-fluid rounded" alt="..."/>
                    <div class="card-body">
                        <h5 class="card-title display-5 fw-bold">Camping Site 1</h5>
                        <table>
                            <tr>
                                <div className="">
                                    <td className="pe-2">
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-start mt-3">
                            <button type="button" class="btn btn-primary btn-lg px-4 me-md-2"><a href="/addon" class="link-light text-decoration-none">Book Now</a></button>
                        </div>
                    </div>
                </div>
                <div class="card flex-lg-row align-items-center my-4">
                    <img src="./sample-image.jpg" class="card-body col-lg-3 img-fluid rounded" alt="..."/>
                    <div class="card-body">
                        <h5 class="card-title display-5 fw-bold">Camping Site 2</h5>
                        <table>
                            <tr>
                                <div className="">
                                    <td className="pe-2">
                ...
                <div class="card flex-lg-row align-items-center mt-4">
                    <img src="./sample-image.jpg" class="card-body col-lg-3 img-fluid rounded" alt="..."/>
                    <div class="card-body">
                        <h5 class="card-title display-5 fw-bold">Camping Site 3</h5>
                        <table>
                            <tr>
                                <div className="">
                                    <td className="pe-2">
